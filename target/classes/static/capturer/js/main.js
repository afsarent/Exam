...
function takeSnapshot() {
  ...
  canvas.height = 420;//height;

  context = canvas.getContext('2d');
  context.drawImage(video, 0, 0, canvas.width, canvas.height);
  console.log("Starting doc writing");
  //document.write('<script src="canvas-to-blob.min.js" type="text/javascript"></script>');
  // Edit the canvas ...
 console.log("checking blob conversion");
  if (canvas.toBlob) {
  canvas.toBlob(function (blob) {
     console.log("Blob converted success");
 	...
 	fetch("http://localhost:5000/file", requestOptions)
